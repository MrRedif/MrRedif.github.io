...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:rn,depthTest:!1,depthWrite:!1})}function sa(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:es(),fragmentShader:`
		...
		`,blending:rn,depthTest:!1,depthWrite:!1})}function aa(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:es(),fragmentShader:`
